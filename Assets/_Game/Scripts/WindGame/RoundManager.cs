...
namespace Ibit.WindGame
{
    public class RoundManager : MonoBehaviour
    {
        ...
        private bool playable, finished, toBackup, countTime;
        [SerializeField] private bool debugSc;
        ...
        private void Start ()
        {
            ...
            countTime = true;//To keep countdown showing
            toBackup = false; //Use old state value(Player haven't played->default state->continue to next state)
            //debugSc = true; Used when you need to bypass connection device verification
            ...
            FindObjectOfType<Player>().PlayerIsPlayingEvent += NoCountdown;
        ...
        private IEnumerator PlayGame ()
        {
            while (!finished)
            {
                ...
                {
                    case 1: //Introduction
                        displayHowTo.text = "Bem-Vindo ao jogo do catavento![ENTER]";
                    ...
                    case 6: //Pre-flow
                        ...
                        TextPanel.SetActive (true);
                        displayHowTo.text = "Pressione [Enter] e ASSOPRE \n o maior tempo que conseguir antes do tempo acabar!.";
                        while (playable)
                            yield return null;
                        CleanRound ();
                        playable = true;
